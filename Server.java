  ...
  public void run() throws IOException {
    ...
    while (true) {
      ...
      newUser.getOutStream().println(
          "<img src='https://media.tenor.com/8QmnopMNjrwAAAAC/chat.gif' height='80' width='100'>"
          + "     <b>Welcome</b>     " + newUser.toString() +
          "<br><br><br><b><u>Terms & Conditions</u><br><i><p>* Make sure you must running the server side application first.</p></i></b>"
          );
